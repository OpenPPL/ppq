...
"""
import sys
sys.path.append("/home/geng/tinyml/ppq/")
...
WORKING_DIRECTORY = '/home/geng/tinyml/ppq/benchmark/dynamic_shape_quant/calib_data'                             # choose your working directory
model_file = "Retinanet-wo-FP32.onnx"
...
if MODEL_TYPE == NetworkFramework.ONNX:
    graph = load_onnx_graph(onnx_import_file = os.path.join(WORKING_DIRECTORY, model_file))
...
# QS.dispatcher = 'conservative'
# def happyforward(*args, **kwards):
#     return torch.zeros([1, 100, 5]).cuda(), torch.zeros([1, 100]).cuda()
# register_operation_handler(happyforward, 'TRTBatchedNMS', platform=TargetPlatform.FP32)
