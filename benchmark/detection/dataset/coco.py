...
class CocoDataset(CustomDataset):
    ...
    def evaluate(self,
        ...
        elif results_json_path:
            result_files = {}
            result_files['bbox'] = results_json_path
            result_files['proposal'] = results_json_path
        else:
           raise ValueError('Both results and results_json_path are None, you must have one!')
        eval_results = self.evaluate_det_segm(result_files, coco_gt,
